...
export class Model {
  ...
  /**
   * Pushes an object into the document if its unique
   * @param  {String} key   a string key that can use dot-notation
   * @param  {Any} value    the value to push
   * @return {Model}        the Model instance
   */
  addToSet(key, value) {
    this.query.$addToSet = this.query.$addToSet || {};
    Object.assign(this.query.$addToSet, { [key]: value });
    return this;
  }
  ...
  mergeChanges(changes) {
    return deepMerge(this, _.dotToNot(changes));
  }
